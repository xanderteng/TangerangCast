...
class APIFetcher:
        ...
        for attempt in range(max_retries):
            try:
                ...
                if response.status_code == 429:
                    raise requests.exceptions.RequestException("429 Too Many Requests - Rate Limit Hit")
    ...
    def fetch_current_grid(self):
        ...
        for i in range(0, len(coords), chunk_size):
            ...
            try:
                ...
                print(f"Skipping current batch {i//chunk_size + 1} due to persistent error: {e}")
    ...
    def fetch_future_grid(self):
            ...
            try:
                ...
                if isinstance(response, list):
                    for idx, location_data in enumerate(response):
                        ...
                        df_temp['Rain'] = df_temp['rain'].apply(lambda x: 1 if x > 0 else 0)
        ...
        cols = [
            'Fetch_Time', 'Forecast_Time', 'Latitude', 'Longitude',
